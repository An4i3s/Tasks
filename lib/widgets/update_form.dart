...
class UpdateForm extends StatefulWidget{
   ...
   //todo invece di passare ogni singolo valore di Task, passare diretmmanete il Task corrente
  // String itemId;
  // String itemTitle;
  Tasks currentTask;
  ...
  var _selectedScadenza = "mese";
   ...
   void upddateItem() async {
     setState(() {
      ...
      final url = Uri.https(
          'tasks-3b776-default-rtdb.firebaseio.com', 'tasks-list/${widget.currentTask.id}.json');
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(
          ...
          child: TextFormField(
            initialValue: widget.isTitle ? widget.initialTitle : widget.initialDescription,
